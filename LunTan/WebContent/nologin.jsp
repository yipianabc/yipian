...
<div class="container-fluid"> 
        ...
        <div class="col-xs-9 col-sm-9" 
            ...
            <p> <font color="red" size="5px">
                        您还没有登录，请前往<a href="login.jsp">登录</a>
                        </font></p>
<img src="https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=501648747,640915126&fm=26&gp=0.jpg" class="img-responsive">
                    </div>
        </div>
 ...
 <div class="col-xs-3 col-sm-3" 
        style="background-color: #dedef8;box-shadow: 
        inset 1px 1px 0px 1px #444, inset -1px 1px 1px #444;height:610px">
...
<footer><p align="center"><a href="">关于论坛| </a><a href="#">隐私政策| </a><a href="#">后台管理</a></p></footer>
</body>
</html>